        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li style = "font-size: 20px;display: inline-block;vertical-align: text-top;font-family:fantasy;" ><img src="images/logofl.png" alt="logo"width="78px" height="65px" style="margin-left: 7px ;margin-right : 15px;margin-top: 0px;margin-bottom: 0px; ">EAT.DRINK.LOVE</li>
                    </ul>
                </div>
            </nav>
        </div>
  ...
  <footer class="page-footer">
    ...
    $("#formValidate").validate({
        ...
        messages: {
           ...
           address:{
                minlength: "Address must be atleast 20 characters long",		
            },		
           balance:{
