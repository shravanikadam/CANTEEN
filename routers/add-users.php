...
$sql = "INSERT INTO users (username, password, name, email, contact, address, role, verified, deleted) VALUES ('$username', '$hashpwd', '$name', '$email', $contact, '$address', '$role', $verified, $deleted)";
